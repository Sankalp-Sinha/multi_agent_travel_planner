...
@traceable(name="tavily-hotel-search", run_type="tool")
...
@traceable(name="aviation-mcp-call", run_type="tool")
...
@traceable(name="aviation-list-airports", run_type="tool")
...
@traceable(name="aviation-list-airlines", run_type="tool")
...
@traceable(name="current-weather", run_type="tool")
...
@traceable(name="weather-forecast", run_type="tool")
